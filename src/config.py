...
# Lần đầu chạy: tự tạo config.json cạnh exe
if getattr(sys, 'frozen', False):
    _extract_if_missing("config.json")

# Load config.json (chỉ chứa settings khách được phép chỉnh)
